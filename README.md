# NovaInvoice | Smart Invoicing on Stellar
...
**NovaInvoice** is a mobile-responsive Stellar testnet dApp for creating shareable XLM invoices and paying them through a Soroban smart contract.
...
| --- | --- |
| ![NovaInvoice mobile create-invoice interface](screenshots/mobileResponsive.png) | ![GitHub, frontend, contract, and Vercel checks passing](screenshots/cipassing%20test.png) |
...
| Requirement | Status | NovaInvoice implementation and evidence |
| --- | --- | --- |
...
| Public repository | ✅ Complete | [Kratika-12/NovaInvoice-](https://github.com/Kratika-12/NovaInvoice-) |
...
NovaInvoice provides specific, recoverable feedback for:
...
```powershell
git clone https://github.com/Kratika-12/NovaInvoice-.git
Set-Location NovaInvoice-
npm install
...
1. Open NovaInvoice at a mobile viewport.
...
![NovaInvoice landing page](screenshots/landing%20page.png)
...
![NovaInvoice dashboard](screenshots/dashboard%20page.png)
...
- [Development plan](../NovaInvoice-Dev-Plan.md)
