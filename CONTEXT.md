# NovaInvoice — Project Context

## Overview
**NovaInvoice** is a decentralized application (dApp) built on the Stellar network. It acts as a "Stripe Invoicing, but on Stellar" where users can easily create payment invoices, generate shareable links/QR codes, and payers can fulfill them securely using their Stellar wallets (via Freighter) on the Testnet.
